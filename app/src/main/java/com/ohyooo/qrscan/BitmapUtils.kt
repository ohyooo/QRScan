...
object BitmapUtils {
    ...
    fun getBitmapFromContentUri(contentResolver: ContentResolver, imageUri: Uri): Bitmap? {
        val decodedBitmap = if (Build.VERSION.SDK_INT < VERSION_CODES.P) {
        ...
        when (orientation) {
            ...
            ExifInterface.ORIENTATION_UNDEFINED, ExifInterface.ORIENTATION_NORMAL -> Unit
            else -> Unit
        }
     ...
     */
    @RequiresApi(VERSION_CODES.KITKAT)
    private fun yuv420ThreePlanesToNV21(yuv420888planes: Array<Plane>, width: Int, height: Int): ByteBuffer {
...
@Parcelize
data class FrameMetadata constructor(val width: Int, val height: Int, val rotation: Int) : Parcelable